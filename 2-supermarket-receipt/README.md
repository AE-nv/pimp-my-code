...
## Disclaimer
This is a straight copy of the [repo by Emily Bache](https://github.com/emilybache/SupermarketReceipt-Refactoring-Kata).
Over there you can find starting points in different languages, as well as branches with or without tests to get started.
